...
# --- COMPNERD ---
if(DEFINED ANDROID_ALTERNATE_TOOLCHAIN)
  file(TO_CMAKE_PATH "${ANDROID_ALTERNATE_TOOLCHAIN}" ANDROID_ALTERNATE_TOOLCHAIN)
  set(ANDROID_TOOLCHAIN_PREFIX ${ANDROID_ALTERNATE_TOOLCHAIN}/bin/${ANDROID_TOOLCHAIN_NAME}-)
endif()
# --- COMPNERD ---
...
if(DEFINED ANDROID_ALTERNATE_TOOLCHAIN)
  set(ANDROID_C_COMPILER
    "${ANDROID_ALTERNATE_TOOLCHAIN}/bin/clang${ANDROID_TOOLCHAIN_SUFFIX}")
  set(ANDROID_CXX_COMPILER
    "${ANDROID_ALTERNATE_TOOLCHAIN}/bin/clang++${ANDROID_TOOLCHAIN_SUFFIX}")
  set(ANDROID_ASM_COMPILER
    "${ANDROID_ALTERNATE_TOOLCHAIN}/bin/clang${ANDROID_TOOLCHAIN_SUFFIX}")
